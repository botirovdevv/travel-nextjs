...
const MobileNav = ({nav, closeNav}:Props) => {
    ...
    return (
        <div className={`fixed ${navAnimation} transform transition-all duration-300 top-0 left-0 right-0 botom-0 z-[10000] bg-[#200f31]`}>
            ...
            <div onClick={closeNav} className="absolute curosr-pointer top-[2rem] z-[1000000] right-[2rem] w-[2rem] h-[2rem] text-white">
                <XMarkIcon />
            </div>
        </div>
    )
