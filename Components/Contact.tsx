...
import Img from "../public/images/c1.png"
    ...
    return (
        <div className='pt-[8rem] pb-[3rem]'>
            <div className='w-[80%] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-[3rem]'>
                ...
                <div className='flex items-center justify-center flex-col' data-aos="fade-left" data-aos-delay="600">
                    <h1 className='text-center w-[90%] xl:w-[70%] tracking-[0.1rem] mx-auto font-bold text-[20px] md:text-[30px] text-black1'>
                        Get special offers and more from Traveler
                    </h1>
                    <p className="mt-[0.7rem] w-[80%] xl:w-[60%] mx-auto text-center text-[15px] text-black opacity-60">Subscribe to see the secret deals prices drop the moment you sign up</p>
