    ...
    <div className='cursor-pointer bg-white rounded-md overflow-hidden'>
      <div className='relative overflow-hidden w-[100%] h-[20rem]'>
        <Image
          src={`${image}`}
          alt={name}
          className='transform object-cover trasition-all duration-700 scale-100 hover:scale-125'
          layout='fill'
        />
      </div>
      <div className='p-[1.4rem]'>
        ...
        <h1 className='mt-[0.4rem] text-[20px] text-black capitaliza font-bold'>
          {name}
        </h1>
        ...
        <div className='flex mt-[0.5rem] items-center space-x-3'>
          ...
          <h1 className='text-[16px] flex items-center space-x-4 font-bold text-black'>
            ...
            <span className='text-[15px] text-black opacity-70 font-normal'>({reviewNum} Rewies)</span>
          </h1>
        </div>
