...
const ClientReview = ({ image, name }: Props) => {
    return (
        <div className='p-4'>
            ...
            <p className='mt-[2rem] text-center text-[16px] text-black opacity-60'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Possimus esse inventore cum sequi, a illum distinctio eaque veniam repellat, odit optio expedita laboriosam minus necessitatibus ipsum omnis, obcaecati consequatur reiciendis.</p>
